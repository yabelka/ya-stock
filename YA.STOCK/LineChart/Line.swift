...
public struct Line: View {
    ...
    public var body: some View {
        ZStack {
            self.closedPath
                .fill(LinearGradient(gradient: Gradient(colors: [Color.black.opacity(0.1), .white]), startPoint: .bottom, endPoint: .top))
...
struct Line_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader{ geometry in
            Line(data: TestData.values, frame: .constant(geometry.frame(in: .local)), touchLocation: .constant(CGPoint(x: 100, y: 12)), showIndicator: .constant(true), minDataValue: .constant(nil), maxDataValue: .constant(nil))
